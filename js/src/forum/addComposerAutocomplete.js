...
import TextEditor from 'duroom/common/components/TextEditor';
import TextEditorButton from 'duroom/common/components/TextEditorButton';
import ReplyComposer from 'duroom/forum/components/ReplyComposer';
import EditPostComposer from 'duroom/forum/components/EditPostComposer';
import avatar from 'duroom/common/helpers/avatar';
import usernameHelper from 'duroom/common/helpers/username';
import highlight from 'duroom/common/helpers/highlight';
import KeyboardNavigatable from 'duroom/forum/utils/KeyboardNavigatable';
import { truncate } from 'duroom/common/utils/string';
import { throttle } from 'duroom/common/utils/throttleDebounce';
                ...
                .forEach((post) => {
                  ...
                  suggestions.push(
                    makeSuggestion(
                      ...
                      [
                        app.translator.trans('duroom-mentions.forum.composer.reply_to_post_text', { number: post.number() }),
                        ' — ',
  ...
  extend(TextEditor.prototype, 'toolbarItems', function (items) {
    items.add(
      ...
      <TextEditorButton onclick={() => this.attrs.composer.editor.insertAtCursor(' @')} icon="fas fa-at">
        {app.translator.trans('duroom-mentions.forum.composer.mention_tooltip')}
      </TextEditorButton>
    );
  });
}
