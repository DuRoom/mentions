...
class ConfigureMentions
{
    ...
    private function configureUserMentions(Configurator $config)
    {
        ...
        $tag->filterChain->prepend([static::class, 'addUserId'])
            ->setJS('function(tag) { return duroom.extensions["duroom-mentions"].filterUserMentions(tag); }');
    ...
    {
        $allow_username_format = (bool) resolve(SettingsRepositoryInterface::class)->get('duroom-mentions.allow_username_format');
    ...
    private function configurePostMentions(Configurator $config)
    {
        ...
        $tag->filterChain
            ...
            ->setJS('function(tag) { return duroom.extensions["duroom-mentions"].filterPostMentions(tag); }');
